...
class CommentModel extends Model
{
  public function GetComments($postId)
  {
    ...
    $comments = $this->db->prepare('SELECT id, author,mail, comment, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin\') AS comment_date_fr FROM comments WHERE post_id = ? ORDER BY comment_date DESC');
